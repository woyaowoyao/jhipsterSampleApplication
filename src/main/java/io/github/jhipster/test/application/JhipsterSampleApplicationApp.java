package io.github.jhipster.test.application;

import io.github.jhipster.test.application.config.ApplicationProperties;
import io.github.jhipster.test.application.config.DefaultProfileUtil;
